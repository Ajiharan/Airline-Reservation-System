...
<jsp:include page="/WEB-INF/view/header.jsp"></jsp:include>
	<div class="container">
		<div class="row">
		<div class="col-lg-12">
				<h2 class="page-header text-center">Update Employee</h2>
			...
			String employee_id=(String)session.getAttribute("my_employee_id");
			ArrayList<Employee> list=air.getEmployeDetails();
			for(Employee myemployee:list){
				if(myemployee.geteid().equals(employee_id)){
				
			
			 %>
			
			
			<form action="UpdateEmployeeServlet" method="post" class="form-horizontal" >
					<div class="form-group form-group-sm">
						<label class="col-sm-2 control-label"><i class="fa fa-user" aria-hidden="true"></i>Employee Name</label>
					  	<div class="col-sm-6">
					  	 	<input type="text" name="ename" class="form-control" value="<%=myemployee.getname() %>" required>
					  	 	<input type="hidden" name="my_emp_id" value="<%=employee_id %>">
					  	</div>
					  </div>
				...
				<div class="form-group form-group-sm">
					<label class="col-sm-2 control-label"><i class="fa fa-user" aria-hidden="true"></i>Address</label>	 
					<div class="col-sm-6">
					<input type="text" name="eaddress" class="form-control" value="<%=myemployee.getAddress() %>" required>
					</div>
				</div>
				<div class="form-group form-group-sm">
						<div class="col-sm-2"></div>
				...
				<div class="form-group form-group-sm">
					<label class="col-sm-2 control-label"><i class="fa fa-envelope" aria-hidden="true"></i>Job</label>	 
					<div class="col-sm-6">
					 <input type="text" class="form-control"  name="ejob" value="<%=myemployee.getJob() %>" required>
					</div>
				</div>
				<div class="form-group form-group-sm">
						<div class="col-sm-2"></div>
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-6">
					 <input type="email" class="form-control"  name="email_id" value="<%=myemployee.getEmail() %>" required>
					</div>
				</div>
				<div class="form-group form-group-sm">
						<div class="col-sm-2"></div>
