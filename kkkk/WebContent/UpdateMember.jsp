...
Customer emp=(Customer)request.getAttribute("CustomerObject");
...
<jsp:include page="/WEB-INF/view/header.jsp"></jsp:include>
	<div class="container">
		<div class="row">
		<div class="col-lg-12">
				<h2 class="page-header text-center">Update Members</h2>
			...
			<form action="AdminUpdate" method="post" class="form-horizontal" >
					<div class="form-group form-group-sm">
						<label class="col-sm-2 control-label"><i class="fas fa-ban"></i> Employee Id</label>
					  	<div class="col-sm-6">
					  	 <input type="text" disabled class="form-control"  value="<%= emp.getI() %>">
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-6">
					 <input type="text" class="form-control"  name="fmail" value="<%=emp.getE() %>" >
					</div>
				</div>
				<div class="form-group form-group-sm">
						<div class="col-sm-2"></div>
				...
				<div class="form-group form-group-sm">
					<div class="col-sm-2"></div>
					<div class="col-sm-6">
					<input type="button" onclick="conformSubmit(this.form);" value="UpdateMember"
