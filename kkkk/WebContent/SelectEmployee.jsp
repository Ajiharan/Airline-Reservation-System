...
<jsp:include page="/WEB-INF/view/header.jsp"></jsp:include>
	<div class="container">
		<div class="row">
		<div class="col-lg-12">
				<h2 class="page-header text-center">Select Employee</h2>
		...
		<% IAirlineInterface face1=new LoginDao();
						...
						ArrayList<Employee> list=face1.getEmployeDetails();
						for(Employee myemployee:list){
						 %>
							...
							<tr>
								...
								<td><%=myemployee.getname()%></td>
								<td><%=myemployee.getJob() %></td>
								<td><%=myemployee.getEmail() %></td>
								
								<td><form method="post" action="SelectEmployeeServlet"><input type="submit" class="btn btn-success" value="select">
								<input type="hidden" name="employee_Id" value="<%=myemployee.geteid() %>"/></form></td>
							</tr>
						<% }%>
						</tbody>
					</table>
